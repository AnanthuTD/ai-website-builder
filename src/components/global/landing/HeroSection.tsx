...
function HeroSection({ onNavigateToDashboard }: HeroSectionProps) {
	return (
				...
				<div className="py-20 md:py-28 lg:py-32 flex flex-col items-start">
					...
					<div className="mt-10 flex flex-col sm:flex-row gap-4">
						<Button
							...
							className="bg-white text-indigo-600 hover:bg-gray-100 px-8 py-6 text-lg !rounded-button whitespace-nowrap cursor-pointer"
						>
							Get Started Free
						</Button>
